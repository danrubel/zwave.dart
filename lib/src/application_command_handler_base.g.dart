...
abstract class ApplicationCommandHandlerBase<T> {
  ...
  T? handleCommandClassAntitheftUnlock(List<int> data) {
    return unhandledCommandClass(
        COMMAND_CLASS_ANTITHEFT_UNLOCK, 'COMMAND_CLASS_ANTITHEFT_UNLOCK', data);
  }
  ...
  T? handleCommandClassAuthentication(List<int> data) {
    return unhandledCommandClass(
        COMMAND_CLASS_AUTHENTICATION, 'COMMAND_CLASS_AUTHENTICATION', data);
  }

  T? handleCommandClassAuthenticationMediaWrite(List<int> data) {
    return unhandledCommandClass(COMMAND_CLASS_AUTHENTICATION_MEDIA_WRITE,
        'COMMAND_CLASS_AUTHENTICATION_MEDIA_WRITE', data);
  }
  ...
  T? handleCommandClassGenericSchedule(List<int> data) {
    return unhandledCommandClass(
        COMMAND_CLASS_GENERIC_SCHEDULE, 'COMMAND_CLASS_GENERIC_SCHEDULE', data);
  }
  ...
  T? handleCommandClassIrRepeater(List<int> data) {
    return unhandledCommandClass(
        COMMAND_CLASS_IR_REPEATER, 'COMMAND_CLASS_IR_REPEATER', data);
  }
  ...
  T? handleCommandClassNotification(List<int> data) {
    switch (data[8]) {
      case NOTIFICATION_REPORT:
        return handleNotificationReport(NotificationReport(data));
      default:
        return unhandledCommandClass(
  ...
  T? handleCommandClassSensorMultilevel(List<int> data) {
    switch (data[8]) {
      case SENSOR_MULTILEVEL_SUPPORTED_SENSOR_REPORT:
        return handleSensorMultilevelSupportedSensorReport(
  ...
  T? handleSensorMultilevelSupportedSensorReport(
      SensorMultilevelSupportedSensorReport report) {
    logger.warning(
        'Unhandled SensorMultilevelSupportedSensorReport from ${report.sourceNode}');
    return null;
  }
